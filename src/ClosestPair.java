...
public class ClosestPair extends JFrame {
    ...
    public ClosestPair() {
        ...
        JLabel coresLabel = new JLabel("CPU Cores: " + cpuCores); // Display the number of CPU cores.
                ...
                if (isHighlighted) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < cpuCores; i++) {
                            ...
                            futures.add(executor.submit(new ClosestPairTask(subset, points)));
                        }
...
class ClosestPairTask implements Callable<Pair> {
    ...
    private final List<Point> subset; // Subset of points to analyze.
    private final List<Point> allPoints; // All points for cross-comparison.

    public ClosestPairTask(List<Point> subset, List<Point> allPoints) {
        this.subset = subset;
    ...
    public Pair call() {
        ...
        // Compare each point in the subset to all points.
        for (Point p1 : subset) {
